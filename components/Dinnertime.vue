                ...
                <li :class="[d.playerUpdated ? 'step step-' + d.playerUpdated.restaurant.class : 'step']"
                    ...
                    <div class="flex md:flex-col">
                        <div class="flex flex-col justify-center place-items-center mr-2 md:mr-0">
                            <span class="text-xs md:text-lg inline-block min-h-[20px]">
                                {{ d.playerUpdated ? d.playerUpdated.name : '' }}
                            </span>
                            <span class="md:text-xl kansas inline-block min-h-[20px]">
                                {{ d.playerUpdated ? d.earns + " $" : '' }}
                            </span>
                        </div>
                        <div class="flex flex-col justify-start md:h-[100px] md:mt-5">
                            ...
                            <div class="h-[195px] flex flex-col justify-center" v-if="d.house.ruralArea">
                        ...
                        <div class="grid grid-rows-2 md:mt-5">
                            <div class="flex md:flex-col justify-center place-items-center">
                                <div class="indicator w-[35px] h-[35px]" v-if="d.house.getNeed(Product.BURGER)">
                                    <span class="indicator-item badge badge-sm">{{
                                ...
                                <div class="indicator w-[35px] h-[35px]" v-if="d.house.getNeed(Product.PIZZA)">
                                    <span class="indicator-item badge badge-sm">{{
                                ...
                                <div class="indicator w-[35px] h-[35px]" v-if="d.house.getNeed(Product.BEER)">
                                    <span class="indicator-item badge badge-sm">{{
                                ...
                                <div class="indicator w-[35px] h-[35px]" v-if="d.house.getNeed(Product.COKE)">
                                    <span class="indicator-item badge badge-sm">{{
                                ...
                                <div class="indicator w-[35px] h-[35px]" v-if="d.house.getNeed(Product.JUICE)">
                                    <span class="indicator-item badge badge-sm">{{
