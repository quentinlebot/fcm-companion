                        ...
                        <div class="grid grid-rows-2">
                            <div class="flex md:flex-col justify-center place-items-center">
                                <div class="indicator w-[35px] h-[35px]">
                                    <span class="indicator-item badge badge-sm" v-if="h.needBurger">{{
                                        h.needBurger
                                    }}</span>
                                    <svg width="35px" viewBox="85 130 40 40" v-if="h.needBurger" :class="[]">
                                ...
                                <div class="indicator w-[35px] h-[35px]">
                                    <span class="indicator-item badge badge-sm" v-if="h.needPizza">{{
                                        h.needPizza
                                    }}</span>
                                    <svg width="35px" viewBox="85 130 40 40" v-if="h.needPizza" :class="[]">
                                ...
                                <div class="indicator w-[35px] h-[35px]">
                                    <span class="indicator-item badge badge-sm" v-if="h.needBeer">{{
                                        h.needBeer
                                    }}</span>
                                    <svg width="35px" viewBox="85 130 40 40" v-if="h.needBeer" :class="[]">
                                ...
                                <div class="indicator w-[35px] h-[35px]">
                                    <span class="indicator-item badge badge-sm" v-if="h.needCoke">{{
                                        h.needCoke
                                    }}</span>
                                    <svg width="35px" viewBox="85 130 40 40" v-if="h.needCoke" :class="[]">
                                ...
                                <div class="indicator w-[35px] h-[35px]">
                                    <span class="indicator-item badge badge-sm" v-if="h.needJuice">{{
                                        h.needJuice
                                    }}</span>
                                    <svg width="35px" viewBox="85 130 40 40" v-if="h.needJuice" :class="[]">
