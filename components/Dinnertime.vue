    ...
    <div class="flex flex-col h-[calc(100vh-64px)] relative place-items-center">
        ...
        <div class="overflow-visible">
            <ul
                    ...
                    <div class="flex md:flex-col md:gap-10">
                        ...
                        <div class="flex md:flex-col">
                            <div class="indicator h-min">
                                <span class="indicator-item badge badge-primary" v-if="h.nbBurger">{{
                                    h.nbBurger
                                }}</span>
                                <svg width="35px" viewBox="85 130 40 40" v-if="h.nbBurger" :class="['cursor-pointer']">
                            ...
                            <div class="indicator h-min">
                                <span class="indicator-item badge badge-primary" v-if="h.nbPizza">{{
                                    h.nbPizza
                                }}</span>
                                <svg width="35px" viewBox="85 130 40 40" v-if="h.nbPizza" :class="['cursor-pointer']">
                            ...
                            <div class="indicator h-min">
                                <span class="indicator-item badge badge-primary" v-if="h.nbBeer">{{
                                    h.nbBeer
                                }}</span>
                                <svg width="35px" viewBox="85 130 40 40" v-if="h.nbBeer" :class="['cursor-pointer']">
                            ...
                            <div class="indicator h-min">
                                <span class="indicator-item badge badge-primary" v-if="h.nbCoke">{{
                                    h.nbCoke
                                }}</span>
                                <svg width="35px" viewBox="85 130 40 40" v-if="h.nbCoke" :class="['cursor-pointer']">
                            ...
                            <div class="indicator h-min">
                                <span class="indicator-item badge badge-primary" v-if="h.nbJuice">{{
                                    h.nbJuice
                                }}</span>
                                <svg width="35px" viewBox="85 130 40 40" v-if="h.nbJuice" :class="['cursor-pointer']">
                ...
                <svg width="35px" disabled viewBox="85 130 40 40">
