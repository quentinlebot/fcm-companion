                        ...
                        <div class="grid grid-rows-2">
                            <div class="flex md:flex-col justify-center place-items-center">
                                <div class="indicator w-[35px] h-[35px]">
                                    <span class="indicator-item badge badge-sm" v-if="h.getNeed(Product.BURGER)">{{
                                        h.getNeed(Product.BURGER)
                                    }}</span>
                                    <svg width="35px" viewBox="85 130 40 40" v-if="h.getNeed(Product.BURGER)" :class="[]">
                                ...
                                <div class="indicator w-[35px] h-[35px]">
                                    <span class="indicator-item badge badge-sm" v-if="h.getNeed(Product.PIZZA)">{{
                                        h.getNeed(Product.PIZZA)
                                    }}</span>
                                    <svg width="35px" viewBox="85 130 40 40" v-if="h.getNeed(Product.PIZZA)" :class="[]">
                                ...
                                <div class="indicator w-[35px] h-[35px]">
                                    <span class="indicator-item badge badge-sm" v-if="h.getNeed(Product.BEER)">{{
                                        h.getNeed(Product.BEER)
                                    }}</span>
                                    <svg width="35px" viewBox="85 130 40 40" v-if="h.getNeed(Product.BEER)" :class="[]">
                                ...
                                <div class="indicator w-[35px] h-[35px]">
                                    <span class="indicator-item badge badge-sm" v-if="h.getNeed(Product.COKE)">{{
                                        h.getNeed(Product.COKE)
                                    }}</span>
                                    <svg width="35px" viewBox="85 130 40 40" v-if="h.getNeed(Product.COKE)" :class="[]">
                                ...
                                <div class="indicator w-[35px] h-[35px]">
                                    <span class="indicator-item badge badge-sm" v-if="h.getNeed(Product.JUICE)">{{
                                        h.getNeed(Product.JUICE)
                                    }}</span>
                                    <svg width="35px" viewBox="85 130 40 40" v-if="h.getNeed(Product.JUICE)" :class="[]">
