                ...
                <li :class="[d.playerUpdated ? 'step-' + d.playerUpdated.restaurant.class : '', 'step', 'm-1']"
                    ...
                    <div class="flex md:flex-col md:gap-10 animate-none">
                        <div class="flex flex-col justify-center">
                            ...
                            <div class="bg-house h-[77px] flex flex-col justify-end" v-if="d.house.gardenReadOnly">
                                <img src="/img/house_garden.jpg" class="w-[50px]" />
                            </div>
                            <div class="bg-house h-[77px] flex flex-col justify-center" v-if="d.house.apartment">
                                <img src="/img/apartment.png" class="w-[50px]" />
                            </div>
                            <div :class="['bg-park mt-1']" v-if="d.house.park">
                        ...
                        <div class="grid grid-rows-2">
                            <div class="flex md:flex-col justify-center place-items-center">
                                <div class="indicator w-[35px] h-[35px]">
                                    <span class="indicator-item badge badge-sm" v-if="d.house.getNeed(Product.BURGER)">{{
                                        d.house.getNeed(Product.BURGER)
                                    }}</span>
                                    <svg width="35px" viewBox="85 130 40 40" v-if="d.house.getNeed(Product.BURGER)"
                                        :class="[]">
                                ...
                                <div class="indicator w-[35px] h-[35px]">
                                    <span class="indicator-item badge badge-sm" v-if="d.house.getNeed(Product.PIZZA)">{{
                                        d.house.getNeed(Product.PIZZA)
                                    }}</span>
                                    <svg width="35px" viewBox="85 130 40 40" v-if="d.house.getNeed(Product.PIZZA)"
                                        :class="[]">
                                ...
                                <div class="indicator w-[35px] h-[35px]">
                                    <span class="indicator-item badge badge-sm" v-if="d.house.getNeed(Product.BEER)">{{
                                        d.house.getNeed(Product.BEER)
                                    }}</span>
                                    <svg width="35px" viewBox="85 130 40 40" v-if="d.house.getNeed(Product.BEER)"
                                        :class="[]">
                                ...
                                <div class="indicator w-[35px] h-[35px]">
                                    <span class="indicator-item badge badge-sm" v-if="d.house.getNeed(Product.COKE)">{{
                                        d.house.getNeed(Product.COKE)
                                    }}</span>
                                    <svg width="35px" viewBox="85 130 40 40" v-if="d.house.getNeed(Product.COKE)"
                                        :class="[]">
                                ...
                                <div class="indicator w-[35px] h-[35px]">
                                    <span class="indicator-item badge badge-sm" v-if="d.house.getNeed(Product.JUICE)">{{
                                        d.house.getNeed(Product.JUICE)
                                    }}</span>
                                    <svg width="35px" viewBox="85 130 40 40" v-if="d.house.getNeed(Product.JUICE)"
                                        :class="[]">
                            ...
                            <div class="flex md:flex-col w-full md:w-min justify-end">
                                <svg v-if="d.kimchi" width="25px" viewBox="85 130 40 40">
                                ...
                                <svg v-if="d.sushi" width="25px" viewBox="85 130 40 40">
                                ...
                                <svg v-if="d.noodle" width="25px" disabled viewBox="85 130 40 40">
