<template>
    <div class="flex flex-col">
        ...
        <div class="flex justify-center place-items-center">
            <div class="flex flex-col justify-center m-5 gap-1">
                <img src="/img/house.jpg" :class="['w-[100px]', selected ? '' : 'grayscale opacity-50']"
                    v-if="!selected.appartment & !selected.gardenReadOnly" />
                <img src="/img/garden.jpg"
                    :class="['w-[100px]', 'cursor-pointer', selected.garden ? '' : 'grayscale opacity-50']"
                    v-if="!selected.gardenReadOnly & !selected.appartment" @click="setGarden()" />
                <img src="/img/house_garden.jpg" class="w-[100px]" v-if="selected.gardenReadOnly" />
                <div class="bg-house h-[150px]" v-if="selected.appartment">
