                ...
                <div class="flex">
                    <div class="indicator">
                        ...
                        <svg width="55px" viewBox="85 130 40 40"
                            :class="['cursor-pointer', selected.getNeed(Product.BURGER) ? '' : 'grayscale opacity-50']"
                    ...
                    <div class="indicator">
                        ...
                        <svg width="55px" viewBox="85 130 40 40"
                            :class="['cursor-pointer', selected.getNeed(Product.PIZZA) ? '' : 'grayscale opacity-50']"
                    ...
                    <div class="indicator">
                        ...
                        <svg width="55px" viewBox="85 130 40 40"
                            :class="['cursor-pointer', selected.getNeed(Product.BEER) ? '' : 'grayscale opacity-50']"
                    ...
                    <div class="indicator">
                        ...
                        <svg width="55px" viewBox="85 130 40 40"
                            :class="['cursor-pointer', selected.getNeed(Product.COKE) ? '' : 'grayscale opacity-50']"
                    ...
                    <div class="indicator">
                        ...
                        <svg width="55px" viewBox="85 130 40 40"
                            :class="['cursor-pointer', selected.getNeed(Product.JUICE) ? '' : 'grayscale opacity-50']"
            ...
            <div class="flex flex-col" v-for="p, i in players" :key="p.name">
                <div class="form-control">
                    ...
                    <input type="number" class="input input-bordered w-full max-w-xs input-xs md:input-md" v-model="dist[i]"
                        @change="p.setDistanceTo(selected.id, dist[i])" />
                    <label class="label">
